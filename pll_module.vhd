...
-- Module  Version: 5.7
--C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_module -lang vhdl -synth lse -arch xo2c00 -type pll -fin 12 -mdiv 1 -ndiv 3 -trimp 0 -phasep 0 -adiv 6 -phase_cntl STATIC -fb_mode 5 -fracn 21845 

-- Sat May 06 13:02:30 2017
...
architecture Structure of pll_module is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "39.999939";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "12.000000";
    attribute ICP_CURRENT of PLLInst_0 : label is "7";
    attribute LPF_RESISTOR of PLLInst_0 : label is "68";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  5, 
        PLL_LOCK_MODE=>  0, CLKOS_TRIM_DELAY=>  0, CLKOS_TRIM_POL=> "FALLING", 
        CLKOP_TRIM_DELAY=>  0, CLKOP_TRIM_POL=> "FALLING", FRACN_DIV=>  21845, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  6, CLKFB_DIV=>  3, CLKI_DIV=>  1, 
